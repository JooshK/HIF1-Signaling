...
<!-- generated with COPASI 4.27 (Build 217) (http://www.copasi.org) at 2019-12-10T16:13:56Z -->
...
Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products.
    ...
    <Function key="Function_40" name="function for Catalysis" type="UserDefined" reversible="unspecified">
      <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Function_40">
    <dcterms:created>
      ...
      <ListOfParameterDescriptions>
        ...
        <ParameterDescription key="FunctionParameter_263" name="Enzyme" order="1" role="modifier"/>
        <ParameterDescription key="FunctionParameter_262" name="O2" order="2" role="modifier"/>
        <ParameterDescription key="FunctionParameter_261" name="Km" order="3" role="constant"/>
        <ParameterDescription key="FunctionParameter_250" name="S" order="4" role="substrate"/>
        <ParameterDescription key="FunctionParameter_265" name="Km1" order="5" role="constant"/>
      </ListOfParameterDescriptions>
    </Function>
    <Function key="Function_41" name="function fro SMM" type="UserDefined" reversible="unspecified">
      <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  ...
  <rdf:Description rdf:about="#Reaction_0">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5378" name="v" value="0.005"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_1">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5377" name="k1" value="0.0002"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_2">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5376" name="k1" value="0.001"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_3">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5375" name="k1" value="1e-05"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=Nguyen2013 - Dynamic model of HIF regulation in hypoxia,Vector=Compartments[Cytosol]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
  ...
  <rdf:Description rdf:about="#Reaction_4">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5374" name="k1" value="0.0002"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=Nguyen2013 - Dynamic model of HIF regulation in hypoxia,Vector=Compartments[Cytosol]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
  ...
  <rdf:Description rdf:about="#Reaction_6">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5372" name="k" value="0.045"/>
          <Constant key="Parameter_5371" name="Km" value="250"/>
          <Constant key="Parameter_5370" name="Km1" value="100"/>
        </ListOfConstants>
        <KineticLaw function="Function_40" unitType="Default" scalingCompartment="CN=Root,Model=Nguyen2013 - Dynamic model of HIF regulation in hypoxia,Vector=Compartments[Cytosol]">
          <ListOfCallParameters>
  ...
  <rdf:Description rdf:about="#Reaction_7">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5369" name="kcat" value="0.1"/>
          <Constant key="Parameter_5368" name="Km" value="150"/>
        </ListOfConstants>
        <KineticLaw function="Function_41" unitType="Default" scalingCompartment="CN=Root,Model=Nguyen2013 - Dynamic model of HIF regulation in hypoxia,Vector=Compartments[Nucleus]">
          <ListOfCallParameters>
  ...
  <rdf:Description rdf:about="#Reaction_8">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5367" name="k" value="0.4"/>
          <Constant key="Parameter_5366" name="Km" value="90"/>
          <Constant key="Parameter_5365" name="Km1" value="20"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_9">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5364" name="k" value="0.045"/>
          <Constant key="Parameter_5363" name="Km" value="250"/>
          <Constant key="Parameter_5362" name="Km1" value="100"/>
        </ListOfConstants>
        <KineticLaw function="Function_40" unitType="Default" scalingCompartment="CN=Root,Model=Nguyen2013 - Dynamic model of HIF regulation in hypoxia,Vector=Compartments[Cytosol]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_264">
  ...
  <rdf:Description rdf:about="#Reaction_10">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5361" name="kcat" value="0.1"/>
          <Constant key="Parameter_5360" name="Km" value="150"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_11">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5359" name="k" value="0.4"/>
          <Constant key="Parameter_5358" name="Km" value="90"/>
          <Constant key="Parameter_5357" name="Km1" value="20"/>
        </ListOfConstants>
        <KineticLaw function="Function_40" unitType="Default" scalingCompartment="CN=Root,Model=Nguyen2013 - Dynamic model of HIF regulation in hypoxia,Vector=Compartments[Cytosol]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_264">
  ...
  <rdf:Description rdf:about="#Reaction_12">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5356" name="k1" value="0.001"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=Nguyen2013 - Dynamic model of HIF regulation in hypoxia,Vector=Compartments[Cytosol]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
  ...
  <rdf:Description rdf:about="#Reaction_13">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5355" name="k" value="0.003"/>
          <Constant key="Parameter_5679" name="Km" value="250"/>
          <Constant key="Parameter_5680" name="Km1" value="100"/>
        </ListOfConstants>
        <KineticLaw function="Function_40" unitType="Default" scalingCompartment="CN=Root,Model=Nguyen2013 - Dynamic model of HIF regulation in hypoxia,Vector=Compartments[Cytosol]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_264">
  ...
  <rdf:Description rdf:about="#Reaction_14">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5678" name="kcat" value="0.01"/>
          <Constant key="Parameter_5681" name="Km" value="150"/>
        </ListOfConstants>
        <KineticLaw function="Function_41" unitType="Default" scalingCompartment="CN=Root,Model=Nguyen2013 - Dynamic model of HIF regulation in hypoxia,Vector=Compartments[Cytosol]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_271">
  ...
  <rdf:Description rdf:about="#Reaction_15">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5708" name="k1" value="0.001"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=Nguyen2013 - Dynamic model of HIF regulation in hypoxia,Vector=Compartments[Cytosol]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
  ...
  <rdf:Description rdf:about="#Reaction_16">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5709" name="k1" value="0.001"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_17">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5707" name="k" value="0.003"/>
          <Constant key="Parameter_5710" name="Km" value="250"/>
          <Constant key="Parameter_5692" name="Km1" value="100"/>
        </ListOfConstants>
        <KineticLaw function="Function_40" unitType="Default" scalingCompartment="CN=Root,Model=Nguyen2013 - Dynamic model of HIF regulation in hypoxia,Vector=Compartments[Cytosol]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_264">
  ...
  <rdf:Description rdf:about="#Reaction_18">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5693" name="kcat" value="0.01"/>
          <Constant key="Parameter_5691" name="Km" value="150"/>
        </ListOfConstants>
        <KineticLaw function="Function_41" unitType="Default" scalingCompartment="CN=Root,Model=Nguyen2013 - Dynamic model of HIF regulation in hypoxia,Vector=Compartments[Cytosol]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_271">
      ...
      <Reaction key="Reaction_19" name="R21-HIF1alphan_HIF1B binding" reversible="true" fast="false" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Reaction_19">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5694" name="k1" value="0.0005"/>
          <Constant key="Parameter_5354" name="k2" value="0.01"/>
        </ListOfConstants>
        <KineticLaw function="Function_14" unitType="Default" scalingCompartment="CN=Root,Model=Nguyen2013 - Dynamic model of HIF regulation in hypoxia,Vector=Compartments[Nucleus]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_69">
              <SourceParameter reference="Parameter_5694"/>
            </CallParameter>
      ...
      <Reaction key="Reaction_20" name="R22-HIFd-HRE_binding" reversible="true" fast="false" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Reaction_20">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5353" name="k1" value="0.001"/>
          <Constant key="Parameter_5352" name="k2" value="0.01"/>
        </ListOfConstants>
        <KineticLaw function="Function_14" unitType="Default" scalingCompartment="CN=Root,Model=Nguyen2013 - Dynamic model of HIF regulation in hypoxia,Vector=Compartments[Nucleus]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_69">
  ...
  <rdf:Description rdf:about="#Reaction_21">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5351" name="k1" value="0.0016"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=Nguyen2013 - Dynamic model of HIF regulation in hypoxia,Vector=Compartments[Cytosol]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
  ...
  <rdf:Description rdf:about="#Reaction_22">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5350" name="k1" value="0.002"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=Nguyen2013 - Dynamic model of HIF regulation in hypoxia,Vector=Compartments[Cytosol]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
  ...
  <rdf:Description rdf:about="#Reaction_23">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5349" name="k1" value="0.00038"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=Nguyen2013 - Dynamic model of HIF regulation in hypoxia,Vector=Compartments[Cytosol]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
  ...
  <rdf:Description rdf:about="#Reaction_24">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5348" name="k1" value="0.009"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=Nguyen2013 - Dynamic model of HIF regulation in hypoxia,Vector=Compartments[Cytosol]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
  ...
  <rdf:Description rdf:about="#Reaction_25">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5347" name="k1" value="0.0001"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=Nguyen2013 - Dynamic model of HIF regulation in hypoxia,Vector=Compartments[Cytosol]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
  ...
  <rdf:Description rdf:about="#Reaction_26">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5346" name="k1" value="0.02"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=Nguyen2013 - Dynamic model of HIF regulation in hypoxia,Vector=Compartments[Cytosol]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
  ...
  <rdf:Description rdf:about="#Reaction_27">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5345" name="k1" value="0.0001"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=Nguyen2013 - Dynamic model of HIF regulation in hypoxia,Vector=Compartments[Cytosol]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
  ...
  <rdf:Description rdf:about="#Reaction_28">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5344" name="k1" value="0.0001"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=Nguyen2013 - Dynamic model of HIF regulation in hypoxia,Vector=Compartments[Cytosol]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
  ...
  <rdf:Description rdf:about="#Event_0">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfAssignments>
          <Assignment target="CN=Root,Model=Nguyen2013 - Dynamic model of HIF regulation in hypoxia,Vector=Compartments[Cytosol],Vector=Metabolites[O2]" targetKey="Metabolite_7">
            <Expression>
...
<dcterms:created>
<rdf:Description>
<dcterms:W3CDTF>2019-12-10T16:12:39Z</dcterms:W3CDTF>
</rdf:Description>
</dcterms:created>
</rdf:Description>
</rdf:RDF>
        ...
        <ModelParameterGroup cn="String=Kinetic Parameters" type="Group">
          ...
          <ModelParameterGroup cn="CN=Root,Model=Nguyen2013 - Dynamic model of HIF regulation in hypoxia,Vector=Reactions[R21-HIF1alphan_HIF1B binding]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Nguyen2013 - Dynamic model of HIF regulation in hypoxia,Vector=Reactions[R21-HIF1alphan_HIF1B binding],ParameterGroup=Parameters,Parameter=k1" value="0.00050000000000000001" type="ReactionParameter" simulationType="fixed"/>
            <ModelParameter cn="CN=Root,Model=Nguyen2013 - Dynamic model of HIF regulation in hypoxia,Vector=Reactions[R21-HIF1alphan_HIF1B binding],ParameterGroup=Parameters,Parameter=k2" value="0.01" type="ReactionParameter" simulationType="fixed"/>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=Nguyen2013 - Dynamic model of HIF regulation in hypoxia,Vector=Reactions[R22-HIFd-HRE_binding]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Nguyen2013 - Dynamic model of HIF regulation in hypoxia,Vector=Reactions[R22-HIFd-HRE_binding],ParameterGroup=Parameters,Parameter=k1" value="0.001" type="ReactionParameter" simulationType="fixed"/>
            <ModelParameter cn="CN=Root,Model=Nguyen2013 - Dynamic model of HIF regulation in hypoxia,Vector=Reactions[R22-HIFd-HRE_binding],ParameterGroup=Parameters,Parameter=k2" value="0.01" type="ReactionParameter" simulationType="fixed"/>
          </ModelParameterGroup>
  ...
  <ListOfLayouts xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
    <Layout key="Layout_2" name="COPASI autolayout">
      ...
      <ListOfReactionGlyphs>
        ...
        <ReactionGlyph key="Layout_53" name="ReactionGlyph" reaction="Reaction_20">
          <BoundingBox>
        ...
        <ReactionGlyph key="Layout_90" name="ReactionGlyph" reaction="Reaction_19">
          <BoundingBox>
...
<dcterms:created>
<rdf:Description>
<dcterms:W3CDTF>2019-12-10T16:12:37Z</dcterms:W3CDTF>
</rdf:Description>
</dcterms:created>
</rdf:Description>
</rdf:RDF>
